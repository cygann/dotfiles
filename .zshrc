...
export ZSH="/Users/nataliecygan/.oh-my-zsh"
...
__conda_setup="$('/Users/nataliecygan/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/nataliecygan/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/Users/nataliecygan/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/nataliecygan/miniforge3/bin:$PATH"
    fi
fi
